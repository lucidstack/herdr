...
pub(crate) mod test_support {
    ...
    use crate::work_items::source::ItemChoices;
    use crate::work_items::state::WorkItem;
    use crate::work_items::{PreparedItem, SourceItem, WorkItemSource};
    ...
    impl WorkItemSource for FakeSource {
        ...
        fn prepare(&self, _item: &SourceItem) -> PreparedItem {
            ...
            PreparedItem {
                detail: None,
                summary: Some("+1 −0 across 1 files".into()),
                error: None,
            }
        }
